											...
											<div class="tab-content">
												<div class="tab-pane fade {if $ssr_prefer}active in{/if}" id="all_ssr">
													...
													<div class="tab-pane fade active in" id="all_ssr_windows">
                                                       ...
                                                       <p><h1><a href="/user/announcement">点击这里查看Windows视频教程</a></h1></p>
                                                      
														<p><span class="icon icon-lg text-white">filter_1</span><a class="btn-dl" href="/ssr-download/SSTap-beta1.97.zip"><i class="material-icons">save_alt</i> 点击下载客户端</a>解压至任意磁盘并运行</p>
													...
													<div class="tab-pane fade" id="all_ssr_mac">
                                                      <p><h1><a href="/user/announcement">点击这里查看Mac傻瓜式教程</a></h1></p>
                                                  ...
                                                  <div class="tab-pane fade" id="all_ssr_linux">
                                                      <p><h1><a href="/user/announcement">点击这里查看Linux傻瓜式教程</a></h1></p>
                                                       
													</div>
													<div class="tab-pane fade" id="all_ssr_ios">
													{if $display_ios_class>=0}
                                                     <p><h1><a href="/user/announcement">点击这里查看iOS视频教程</a></h1></p> 
														...
														{/if}
													{/if}
													<p><span class="icon icon-lg text-white">filter_1</span><a class="btn-dl" href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/xcxnig/ssr-download/master/potatso-lite.plist"><i class="material-icons">save_alt</i> 点击在线安装 Potatso Lite</a></p> <p><a class="btn-dl" href="itms-services://?action=download-manifest&url=https://www.romyun.tk/shiping/Quantumult.plist"><i class="material-icons">save_alt</i> 点击在线安装 Quantumult</a></p><p><a class="btn-dl" href="itms-services://?action=download-manifest&url=https://www.romyun.tk/shiping/shadowsocksgooogle.how381.plist"><i class="material-icons">save_alt</i> 点击在线安装shadowsocks</a> </p>
                                                     <p><a class="btn-dl" href="https://hk.pgug.tk/down2/index.html"><i class="material-icons">save_alt</i> 点击在线安装小火箭</a></p>
														<p><span class="icon icon-lg text-white">filter_2</span> 打开 Potatso Lite，点击添加代理，点击右上角的 + 号，选择“订阅”，名字任意填写，开启自动更新，URL填写以下地址并保存即可</p>
														<p>如果使用shadowrocket,打开 Shadowrocket，点击右上角的 + 号，类型选择“Subscribe”，URL填写以下地址并点击右上角完成即可。或使用
                                                          <p><span class="icon icon-lg text-white">filter_3</span> <a href="javascript:void(0);" class="btn-dl" style="margin-left: 5px;" data-onekeyfor="sub0"><i class="material-icons icon-sm">how_to_vote</i>小火箭一键{if !$mergeSub}普通{/if}端口订阅</a></p>
                                                          <p><span class="icon icon-lg text-white">filter_4</span>{if !$mergeSub}<a href="javascript:void(0);" class="btn-dl" style="margin-left: 5px;" data-onekeyfor="sub1"><i class="material-icons icon-sm">how_to_vote</i>小火箭一键单端口订阅</a>{/if}</p>
                                                          <p><div><span class="icon icon-lg text-white">flash_auto</span> {if !$mergeSub}普通节点{/if}订阅地址：</div></p>
													...
													<div class="tab-pane fade" id="all_ssr_android">
                                                      <p><h1><a href="/user/announcement">点击这里查看Android视频教程</a></h1></p>
													...
													<p>梅林：</p>
                                                       <p><h1><a href="/user/announcement">点击这里查看梅林客户端傻瓜式教程</a></h1></p>
                                                    ...
                                                    <div class="tab-pane fade" id="all_ssr_game">
                                                       <p><h1><a href="/user/announcement">点击这里查看游戏客户端傻瓜式教程</a></h1></p>
