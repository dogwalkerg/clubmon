                    ...
                    <div class="card margin-bottom-no">
                        <div class="card-main">
                            <div class="card-inner">
                                <div class="card-inner">
                                    <!--
										<p class="card-heading">提示!</p>
										-->
                                    <p>充值完成后需刷新网页以查看余额，通常1秒钟内到账，未到账请联系客服</p>
                                  ...
                                  <p><h3><font color="#292828">当前余额：<code>{$user->money}</code>元</font></h3></p>
                                  <p><h3><font color="#292828">购买套餐页面：<a href="/user/shop"><font color="#EB9E02">点击进入购买套餐</font></h3></a></p>
                                  <p><h3><font color="#292828">购买充值码页面：<a href="https://f2fpay.pgug.tk/"><font color="#EB9E02">点击进入购买充值码</font></h3></a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-main">
                            <div class="card-inner">
                                <div class="card-inner">
                                  ...
                                  <p><h3><font color="#F90307">先点上面购买充值码，购买到的充值码粘贴到下面框里，点下面的充值立即到账！</font></h3></p>
