...
<html class="full-height" lang="zh">
  <head>
    ...
    <link href="assets2/css/animate.min.css" tppabs="/assets2/css/animate.min.css" rel="stylesheet">
    ...
    <link href="css/mdb.css?v=20180305" tppabs="css/mdb.css" rel="stylesheet">
    <link rel="stylesheet" href="css/fakeLoader.css" tppabs="css/fakeLoader.css">
...
#intro {
  background: url("https://img.xjh.me/random_img.php?type=bg&ctype=nature&return=302")/*tpa=https://img.xjh.me/random_img.php?type=bg&ctype=nature&return=302*/ no-repeat center center;
...
#pricing .card-image {
  background: url("img/login.jpeg")/*tpa=img/login.jpeg*//*tpa=img/login.jpeg*/ no-repeat center center;
}
...
@font-face{
    font-family:anticon;
    src:url("../at.alicdn.com/t/font_zck90zmlh7hf47vi.eot")/*tpa=https://at.alicdn.com/t/font_zck90zmlh7hf47vi.eot*/;
    src:url("../at.alicdn.com/t/font_zck90zmlh7hf47vi.eot-#iefix")/*tpa=https://at.alicdn.com/t/font_zck90zmlh7hf47vi.eot?#iefix*/ format("embedded-opentype"),url("../at.alicdn.com/t/font_zck90zmlh7hf47vi.woff")/*tpa=https://at.alicdn.com/t/font_zck90zmlh7hf47vi.woff*/ format("woff"),url("../at.alicdn.com/t/font_zck90zmlh7hf47vi.ttf")/*tpa=https://at.alicdn.com/t/font_zck90zmlh7hf47vi.ttf*/ format("truetype"),url("../at.alicdn.com/t/font_zck90zmlh7hf47vi.svg#iconfont")/*tpa=https://at.alicdn.com/t/font_zck90zmlh7hf47vi.svg#iconfont*/ format("svg")
}
     ...
     <nav class="navbar navbar-primary navbar-transparent navbar-absolute">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand  animated swing" href="/" tppabs="">ShaodWingy官网</a>
            </div>
              ...
              <div class="col-md-10 col-lg-6 text-center text-md-left margins">
                <div class="white-text">
                  <div class="wow fadeInLeft" data-wow-delay="0.3s" style="text-shadow:2px 2px 2px #000;">
                    <h1 class="h1-responsive font-bold mt-sm-5">ShaodWingy官网</h1>
                    <div class="h6" style="text-transform:none">
                   比VPN快<br>
<h4>与YouTube，Google，Facebook，Twiter等的闪电连接<h4>
                    </div>
                  </div><br>
                  <div class="wow fadeInLeft" data-wow-delay="0.3s">
                    <a class="btn btn-white dark-grey-text font-bold ml-0" href="auth/register" tppabs="auth/register" target="_blank"><i class="fa fa-user-plus" aria-hidden="true"></i>注册</a>
                    <a class="btn btn-outline-white waves-effect waves-light" href="auth/login" tppabs="auth/login"><i class="fa fa-paper-plane" aria-hidden="true"></i> 登录</a>
                    <!--迷改
            ...
            <div class="banner0-icon"><i class="fa fa-arrow-down" aria-hidden="true"></i></div>
          </div>
        </div>
      </section>
    </header>
...
<section class="row no-gutters" id="features">
  <div class="col-lg-3 col-md-6 col-sm-12 deep-purple lighten-1 text-white">
    <div class="p-5 text-center wow zoomIn" data-wow-delay=".1s"><i class="fa fa-gamepad  fa-2x"></i>
  ...
  <div class="col-lg-3 col-md-6 purple lighten-1 text-white">
    <div class="p-5 text-center wow zoomIn" data-wow-delay=".3s"><i class="fa fa-graduation-cap fa-2x"></i>
  ...
  <div class="col-lg-3 col-md-6 teal lighten-1 text-white">
    <div class="p-5 text-center wow zoomIn" data-wow-delay=".5s"><i class="fa fa-comments fa-2x"></i>
  ...
  <div class="col-lg-3 col-md-6 light-blue lighten-1 text-white">
    <div class="p-5 text-center wow zoomIn" data-wow-delay=".7s"><i class="fa fa-share-alt fa-2x"></i>
...
<div class="container">
    <div class="wow fadeIn">
      ...
      <p class="px-5 mb-5 pb-3 lead blue-grey-text">
        我们支持Windows，macOS，iOS，Android，Linux和Merlin。可以从任何设备轻松连接。
      </p>
    </div>
<img src="img/tupian.jpg" style="width:100%;">
  </div>
</section>
<section class="py-5" id="projects">
  <div class="container">
    ...
    <div class="row wow fadeInLeft" data-wow-delay=".3s">
      <div class="col-lg-6 col-xl-5 pr-lg-5 pb-5"><img class="img-fluid rounded z-depth-2" src="img/card-1.jpg" tppabs="img/card-1.jpg" alt="project image"/></div>
    ...
    <div class="row pt-5 wow fadeInRight" data-wow-delay=".3s">
      ...
      <div class="col-lg-6 col-xl-5 mb-3"><img class="img-fluid rounded z-depth-2" src="img/card-2.jpg" tppabs="img/card-2.jpg" alt="project image"/></div>
    </div>
  </div>
</section>
<section class="text-center py-5 indigo darken-1 text-white" id="pricing">
    ...
    <footer class="page-footer indigo darken-2 center-on-small-only pt-0 mt-0">
     ...
     <div class="footer-copyright">
        <div class="container-fluid">
          <p>&copy; <a href="index" tppabs=""></a>ShadoWingy官网 2019</p>
        </div>
      </div>
    </footer>
   ...
   <script type="text/javascript" src="js/snow.js" tppabs="js/snow.js"></script>
  <!--  <script text="text/javascript" src="/assets2/js/particle.js"></script> -->

    <script type="text/javascript" src="js/popper.min.js" tppabs="js/popper.min.js"></script>
    <script type="text/javascript" src="js/mdb.min.js" tppabs="js/mdb.min.js"></script>
    <script type="text/javascript" src="js/fakeLoader.min.js" tppabs="js/fakeLoader.min.js"></script>
